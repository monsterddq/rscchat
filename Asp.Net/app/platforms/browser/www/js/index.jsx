...
class App extends React.Component {
    ...
    handleMenu(id){
      ...
      if(id!=1) clearInterval(interval_room);
      else {
...
class Contact extends React.Component{
  constructor(props){
    super(props);
    this.state = {
      contacts: JSON.parse(localStorage.getItem("contacts")).sort(compare) || [],
      contactsFilter: JSON.parse(localStorage.getItem("contacts")).sort(compare) || []
    }
  }
